...
CardWindow::CardWindow(CardWidget *_card, QWidget *parent)
        : card(_card), QDialog(parent) {
    ...
    // Add tag button
    QPushButton *addTagButton = new QPushButton(QObject::tr("Метку"));
    ...
    // Add deadline button
    QPushButton *addDeadlineButton = new QPushButton(QObject::tr("Дату"));
