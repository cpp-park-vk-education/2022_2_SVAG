...
void Navbar::Draw() {
    ...
    QSpacerItem *spacer_1 = new QSpacerItem(spacerWidth, spacerHeight, QSizePolicy::Fixed, QSizePolicy::Minimum);
    ...
    setStyleSheet
            (
                ...
                (
                    ...
                    "}\n"
                    "\n"
                    "#chooseBoard QListView::item:focus, #chooseBoard QListView::item:hover, #chooseBoard QListView::item:selected {\n"
