...
BoardWidget::BoardWidget(size_t _ID) :
        ID(_ID),
        name(""),
        columnWidgets(QVector<ColumnWidget *>()),
        users(QVector<UiUser>()),
...
BoardWidget::BoardWidget(size_t _ID, QString _name, QVector<ColumnWidget *> _columnWidgets, QVector <UiUser> _users) :
        ID(_ID),
        name(_name),
        columnWidgets(_columnWidgets),
        users(_users),
