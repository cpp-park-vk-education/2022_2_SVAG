...
RegWindow::RegWindow(QWidget *parent) : QDialog(parent) {
  ...
  userNameIcon->setAlignment(Qt::AlignRight | Qt::AlignTrailing |
                             Qt::AlignVCenter);
  ...
  userNameEdit->setValidator(new QRegularExpressionValidator(
      QRegularExpression("[A-Za-z][A-Za-z0-9_]{7,29}")));
  ...
  emailIcon->setAlignment(Qt::AlignRight | Qt::AlignTrailing |
                          Qt::AlignVCenter);
  ...
  emaildEdit->setValidator(new QRegularExpressionValidator(QRegularExpression(
  ...
  passwordIcon->setAlignment(Qt::AlignRight | Qt::AlignTrailing |
                             Qt::AlignVCenter);
  ...
  repeatPasswordIcon->setAlignment(Qt::AlignRight | Qt::AlignTrailing |
                                   Qt::AlignVCenter);
  ...
  connect(loginLabel, &QPushButton::clicked, this,
          &RegWindow::openAuthSignal);
}
