...
AuthWindow::AuthWindow(QWidget *parent) : QDialog(parent) {
  ...
  QPushButton *registerLabel =
      new QPushButton(QObject::tr("Зарегистрироваться"));
  ...
  connect(loginButton, &QPushButton::clicked, this,
          &AuthWindow::authClickedSlot);
  connect(registerLabel, &QPushButton::clicked, this,
          &AuthWindow::openRegSignal);
  //  connect(registerLabel, &QLabel::linkActivated, this,
  //  &AuthWindow::openRegSlot);
}
